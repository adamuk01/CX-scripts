...
# This load the Senior results -0 as the U23 and Seniors are in the same race. Category position should be race position
...
with open(csv_file, 'r', newline='') as csvfile:
    ...
    for row in csvreader:
        ...
        updated_field2 = row[0]  # Category position is actualy the finish position! Not category!
