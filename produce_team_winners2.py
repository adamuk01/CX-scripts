...
# This will output the team patipation award - it starts with each round and picks the top 6 riders scores. Shows all including zero scores...
...
parser = argparse.ArgumentParser(description="Produce report for team partipation award")
...
if __name__ == "__main__":
    # Example usage
    print("Position,Club name,Points")
